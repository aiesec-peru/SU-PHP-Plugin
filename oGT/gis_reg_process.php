<?php
	...
	try {
  			Podio::authenticate_with_app(20410415, '00b0d73d40db456cb433ca87ec055d2d');
			...
			list($v8, $v15) = explode("|", $v7); // universidad - LC
			$v9 = $_POST['carrera'];
			$v10 = $_POST['ciclo'];
...
$user_lc = strval($v15);
$university = strval($v8);

$referral_type_num = intval($_POST['interested_when']);
$referral_type = '';


switch($referral_type_num){
	case '1': $referral_type = 'Facebook'; break;
	case '3': $referral_type = 'Instagram'; break;
	case '4': $referral_type = 'Recomendado por amigo o familiar'; break;
	case '5': $referral_type = 'Stand en Universidad'; break;
	case '6': $referral_type = 'Evento'; break;
	case '7': $referral_type = 'Soy miembro de AIESEC'; break;
	case '8': $referral_type = 'Otro'; break;
	case '9': $referral_type = 'Twitter'; break;
	case '10': $referral_type = 'Linkedin'; break;
	case '11': $referral_type = 'Publicidad en Universidad'; break;
	case '12': $referral_type = 'Alumni'; break;
}
...
$fields = array(
    ...
    'user[lc]' => $user_lc,
    'user[alignment_id]' => $university, //universidad
    'user[referral_type]' => $referral_type, //medio de interes
    'user[selected_programmes][]' => '2', //Talento Global ID=2
    'commit' => 'REGISTER'
    );
