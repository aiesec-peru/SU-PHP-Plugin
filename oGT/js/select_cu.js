...
$(document).ready(function () 
	{
   		$.getJSON("https://aiesec.pe/wp-content/plugins/oGT/data/ciudades.json",function (data) {
			ciudades = data; 
			});
	 $.getJSON("https://aiesec.pe/wp-content/plugins/oGT/data/comites.json",function (data) {
		comites = data; 
		});	
    
		$.getJSON("https://aiesec.pe/wp-content/plugins/oGT/data/universidades.json", function (data) {
        universidades = data;
        setTimeout(function () {
		...
		$.getJSON("https://aiesec.pe/wp-content/plugins/oGT/data/carreras.json",function (data) 
			{
			carreras = data; 
	    	});
		setTimeout(function () {
