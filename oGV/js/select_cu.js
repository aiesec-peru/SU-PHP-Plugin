...
$(document).ready(function () 
	{
   		$.getJSON("https://aiesec.pe/wp-content/plugins/oGV/data/ciudades.json",function (data) {
			ciudades = data; 
			});
	 $.getJSON("https://aiesec.pe/wp-content/plugins/oGV/data/comites.json",function (data) {
		comites = data; 
		});	
    
		$.getJSON("https://aiesec.pe/wp-content/plugins/oGV/data/universidades.json", function (data) {
        universidades = data;
        setTimeout(function () {
		...
		$.getJSON("https://aiesec.pe/wp-content/plugins/oGV/data/carreras.json",function (data) 
			{
			carreras = data; 
	    	});
		setTimeout(function () {
