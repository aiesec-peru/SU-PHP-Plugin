...
<script type='text/javascript' src='https://aiesec.pe/wp-content/plugins/oGE/js/select_cu.js'></script>
<script type='text/javascript' src='https://aiesec.pe/wp-content/plugins/oGE/js/disable.js'></script>
    ...
    <form action="{path-gis_reg_process}" method="POST" class="regform" id="expa_reg_form" accept-charset="UTF-8" 
        ...
        <table class="sighnup-form-table" style="background-color: transparent;">
            ...
            <tr>
                ...
                <td style="width:66%;">
                    <input 	style="border:1px solid #037Ef3; height: 30px; width: 95%;" id="edad" class="input" type="text" placeholder="18"
                        	name="edad" maxlength="2" required oninvalid="this.setCustomValidity('Ingresa tu edad')"
                        	oninput="setCustomValidity('')">
                </td>
            </tr>
            ...
            <tr>
                <td style="vertical-align: top;padding-top: 15px; width:30%; padding-left: 5%;text-align: right;" class="input-name">
                    <h6 style="font-weight:normal; display:inline;font-style:inherit;">Cuidad</h6>
                    <span class="required">*</span>
                </td>
                <td>
	    ...
	    <select id="universidad_expa" name="universidad_expa" style="display:none">
            ...
            <tr>
                ...
                <td>
                    <select id="interested_in" name="interested_in" title="{interested_in}" style="border:1px solid #037Ef3; width: 95%;">
                        <option selected value="5" style="background-color: #fff;">Emprendedor Global</option>
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <select id="interested_when" name="interested_when" title="{interested_when}" style="border:1px solid #037Ef3; width: 95%;">
                        ...
                        <option value="Facebook" style="background-color: #fff;">Facebook</option>
                        <option value="Evento" style="background-color: #fff;">Evento</option>
                        <option value="Stand en Universidad" style="background-color: #fff;">Stand en Universidad</option>
                        <option value="Amigos o Familia" style="background-color: #fff;">Amigos o Familia</option>
                        <option value="Instagram" style="background-color: #fff;">Instagram</option>
                        <option value="Twitter" style="background-color: #fff;">Twitter</option>
                        <option value="LinkedIn" style="background-color: #fff;">LinkedIn</option>
                        <option value="Publicidad en Universidad" style="background-color: #fff;">Publicidad en Universidad</option>
                        <option value="Soy Miembro de AIESEC" style="background-color: #fff;">Soy Miembro de AIESEC</option>
                        <option value="Alumni" style="background-color: #fff;">Alumni</option>
                        <option value="Otro" style="background-color: #fff;">Otro</option>
                    </select>
                </td>
            </tr>
