<?php
	...
	try {
  			Podio::authenticate_with_app(20318533, 'ac7f4d60e3e74e8391b058110770eb9c');
			...
			// new PodioCategoryItemField(array("external_id" => "programa-de-interes", "values" 	=> intval($v12))),
		  	...
		  	$item = new PodioItem(array	(	'app' => new PodioApp(20318533), // Attach to app with app_id=123
											'fields' => $fields
		  								));
...
$fields = array(
    ...
    'user[selected_programmes][]' => '5', //Emprendedor Global ID=5
    'commit' => 'REGISTER'
    );
...
header("Location: http://aiesec.pe/jovenes-2/bienvenidoge/");
