...
$(document).ready(function () 
	{
   		$.getJSON("https://aiesec.pe/wp-content/plugins/oGE/data/ciudades.json",function (data) {
			ciudades = data; 
			});
	 $.getJSON("https://aiesec.pe/wp-content/plugins/oGE/data/comites.json",function (data) {
		comites = data; 
		});	
    
		$.getJSON("https://aiesec.pe/wp-content/plugins/oGE/data/universidades.json", function (data) {
        universidades = data;
        setTimeout(function () {
